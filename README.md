...
9. App_09 (React) is written according to this [tutorial](https://www.youtube.com/watch?v=iDs5Woed47c). API key is not hosted
   on <github.com>. Conversion rates are taken from
